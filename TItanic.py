...
def MarvellousTitanicLogistic():
    ...
    countplot(data=titanic_data,x=target).set_title("Marvellous Infosystems : Survived and non Survived passengers based on Gender")
    show()
    ...
    titanic_data["Fare"].plot.hist().set_title("Marvellous Infosystems : Survived and non survived based on fare")
    show()
    ...
    print("Value of dataset after removing irrelevant columns")
